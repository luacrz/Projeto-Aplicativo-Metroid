...
LOOP_JOGO:#### RENDERIZAÇÃO PERSONAGEM
		...
		la a0,cenario1 #INICIA O REGISTRADOR COM A IMAGEM DO MENU
		...
		la t1,MAP_POS # carrega a posição do mapa para saber se o personagem esta nela
		lw a4,0(t1)
...
PRINT_MAPA:	#### PREPARATIVOS PARA O BITMAP DISPLAY
		...
		lw t6,0(a6)
		add t1,t1,t6
PRINT_LINHA_MAPA: #### PARA COMEÇAR A DESENHAR NO BITMAP DISPLAY
		...
		addi t3,t3,4 # contador de colunas, para verificar até onde pode desenhar nessa linha
		blt t3,t4,PRINT_LINHA_MAPA # enquanto o endereço atual for menor que a largura da linha, pode continuar desenhando
		...
		mv t3,zero # zera o contador de colunas para voltar para o inicio também
		addi t2,t2,1 # adiciona 1 no contador de linhas
		bgt t5,t2,PRINT_LINHA_MAPA # ENQUANTO A ALTURA INTEIRA DA IMAGEM NÃO FOR IMPRESSA, NÃO PARA
